...
<!-- Mirrored from preview.uideck.com/items/thehunt/register.html by HTTrack Website Copier/3.x [XR&CO'2010], Wed, 21 Nov 2018 08:11:27 GMT -->
<head>
...
<form class="login-form" action="signup_post" method="post">
...
<button class="btn btn-common log-btn mt-3" type="submit" value="submit" name="submit">Register</button>
